...
#### Cycle 5: MS-ESS2-5
**Performance Expectation:** Collect data to provide evidence for how the motions and complex interactions of air masses result in changes in weather conditions.
...
#### Cycle 7: MS-ESS1-4
**Performance Expectation:** Construct a scientific explanation based on evidence from rock strata for how the geologic time scale is used to organize Earth's history.
...
#### Cycle 5: MS-PS4-2
**Performance Expectation:** Develop and use a model to describe that waves are reflected, absorbed, or transmitted through various materials.
...
#### Cycle 6: MS-PS2-3
**Performance Expectation:** Ask questions about data to determine the factors that affect the strength of electric and magnetic forces.
...
### Spiral Question Structure

Each exit ticket includes:
- **2 Spiral Questions**: Review concepts from 1-2 cycles prior
- **1 Integration Question**: Connect current and previous learning
- **2-3 New Content Questions**: Assess current cycle understanding

### Spiral Effectiveness Targets

| Metric | Target | Intervention Trigger |
|--------|--------|---------------------|
| Spiral Question Average | ≥60% | Below 60% triggers reteach |
| Retention Rate | ≥70% | Below 70% flags concept for additional spiral |
| Improvement from Original | ≥10 pts | No improvement triggers SST review |

---

## Assessment Alignment

### Weekly Assessment Structure (100 points)

| Component | Points | Primary SEP | Primary CCC |
|-----------|--------|-------------|-------------|
| Hook | 12 | SEP-1 | Varies |
| Station 1 | 20 | SEP-4/SEP-6 | CCC-2 |
| Station 2 | 20 | SEP-2/SEP-4 | CCC-4 |
| Station 3 | 25 | SEP-6/SEP-8 | CCC-5 |
| Exit Ticket | 23 | Mixed | Mixed + Spiral |
